...
public class AdminCommentController {
    ...
    public UserDtoForAdmin addBanCommited(@PathVariable Long userId, @RequestParam Long eventId) {
    ...
    public void deleteBanCommited(@PathVariable Long userId, @RequestParam Long eventId) {
